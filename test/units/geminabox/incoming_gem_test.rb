  ...
  class IncomingGemTest < Minitest::Test
    ...
    test "#new" do
      assert_raises ArgumentError do
        HetznerGeminabox::IncomingGem.new("NOT AN IO :(")
      end
    end

    test "#valid?" do
      subject = HetznerGeminabox::IncomingGem.new(StringIO.new('NOT A GEM'))
      refute subject.valid?

      file = File.open(GemFactory.gem_file(:example))
      subject = HetznerGeminabox::IncomingGem.new(file)
    ...
    test "#dest_filename" do
      file = File.open(GemFactory.gem_file(:example))
      subject = HetznerGeminabox::IncomingGem.new(file, "/root/path")
